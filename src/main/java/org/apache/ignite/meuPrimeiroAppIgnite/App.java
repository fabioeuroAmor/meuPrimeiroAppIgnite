package org.apache.ignite.meuPrimeiroAppIgnite;
...
public class App {
	public static void main(String[] args) throws IgniteException {
		...
		System.out.println("Minha primeira APP ignite!!!");
		...
		IgniteConfiguration cfg = new IgniteConfiguration();
		 ...
		 //cfg.setClientMode(true);
		  ...
		  Ignite ignite =Ignition.start("C:\\AmbienteBB\\pin-ignite\\meuPrimeiroAppIgnite\\config\\first-cluster.xml");
		  
		  //Criando um IgniteCache e colocando alguns valores nele.
		  IgniteCache<Integer, String> cache = ignite.getOrCreateCache("myCache");
		  cache.put(1, "Hello"); 
		  cache.put(2, "World!");
		  cache.put(3, "Terceiro objeto em cache de memória!");
